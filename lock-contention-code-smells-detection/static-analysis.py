"""
----------------------------------------------------------------
| Script Name: Static Analysis                                 |
| Developer: Ashadullah Shawon                                 |
| Description: Detect and Extract Lock Contention Code-Smells  |
|              Generate Static Recommendations & Dataset       |
| Version: [1.0.0]                                             |
| Date: [2024-10-20]                                           |
---------------------------------------------------------------
...
Usage:
    ...
    Example: python3 static-analysis.py Eventbus
